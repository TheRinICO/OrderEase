<template>
	<view style="padding: 20rpx;">
		...
		<!-- 提交按钮 -->
			<view v-if="amount.discount" class="box" style="position: fixed; bottom: 0; width: 100%;left: 0;">
				<view style="text-align: right;">
					<text>已优惠</text>
					<text style="color: red;">￥{{ amount.discount }}</text>
					<text style="margin-left: 20rpx;">小计</text>
					<text style="color: red; font-size: 36rpx; font-weight: bold;">￥{{ amount.actual }}</text>
					<button @click="addOrders" size="mini" type="primary" style="margin-left: 20rpx; 
