<template>
	<view style="padding: 20rpx;">
		...
		<view class="box" style="display: flex;">
			<view style="flex: 1; display: flex; flex-direction: column; justify-content: space-between;">
				<view style="font-size: 36rpx; font-weight: bold;">
					{{ business.name || '' }}
					<uni-icons @click="saveCollect" style="margin-left: 15rpx;" :color="business.isCollect?'#409EFF':'#999'" size="18" type="star-filled"></uni-icons>
				</view>
				<view>
		...
		<view style="margin: 20rpx 0;">
			<view
				style="box-shadow: 0 4rpx 20rpx rgba(0, 0, 0, .1);border-radius: 10rpx;background-color: #fff; display: flex; border-radius: 10rpx; overflow: hidden; margin-bottom: 10rpx;">
			...
			<!-- 分类商品展示 -->
			<view v-if="current==='全部商品'" class="box" style="display: flex; background-color: #fff; border-radius: 10rpx; padding: 10rpx;height: calc(100vh - 600rpx);">
				<scroll-view scroll-y="true" style="width: 200rpx; text-align: center;">
		...
		<uni-goods-nav style="position: fixed; bottom: 15rpx; width: 100%; left:0;" :fill="true" :options="options" :buttonGroup="buttonGroup" @click="onClick"
		...
		<uni-popup ref="popup" type="bottom" background-color="#fff">
			<scroll-view style="max-height: 70vh;" scroll-y="true">
				<view style="padding: 40rpx 40rpx 140rpx 40rpx;">
					...
					<view v-show="!cartList.length" style="height: 100%;text-align: center;color: #999;margin-top: 10rpx;">
						没有商品
					</view>
