<template>
	<view>
		...
		<view style="padding: 20rpx;">
			...
			<!-- 商家列表 -->
			<view class="box" style="color: #409EFF; font-size: 32rpx; font-weight: bold; margin-bottom: 10rpx;">
				热门商家
			</view>
				...
				<view class="box" v-for="item in businessList" :key="item.id" @click="goToDeatil(item.id)"
					...
					<view style="flex: 1; display: flex; flex-direction: column; justify-content: space-between; grid-gap: 10rpx;">
						...
						<view style="display: flex;  color: #666; ">
							<view style="flex: 1;">
								<text style="color: red; font-weight: bold;">{{item.score}}分</text>
						...
						<view style="color: #409EFF;">免配送费</view>
						
						<view style="color: #5e5e5e; border-radius: 4rpx; width: fit-content;">{{ item.info || '商家介绍' }}</view>
					</view>
				</view>
			</view>
		</view>
