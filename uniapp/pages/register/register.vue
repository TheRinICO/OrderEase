<template>
	<view style="padding: 40rpx;">
		<view
			...
			<view style="margin: 50rpx auto; font-size: 40rpx;text-align: center;">欢迎注册</view>
			<uni-forms ref="form" :modelValue="form" :rules="rules" validateTrigger='blur'>
				...
				<uni-forms-item>
					<button @click="register()" style="background-color: #409EFF; border-color: #409EFF; 
						height: 70rpx; line-height: 70rpx;color: white;">注 册</button>
				</uni-forms-item>
				<uni-forms-item>
